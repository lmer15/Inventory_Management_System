 ...
 * @author Elmer Rapon
 */
public class UpdateDR extends javax.swing.JInternalFrame {

    /**
     * Creates new form UpdateDR
     */
    public UpdateDR() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel4);
        jPanel4.setBounds(10, 160, 760, 250);
        ...
        drError.setText("!Number doesn't exist");
        jPanel2.add(drError);
        ...
        if (DrCode.isEmpty() || custCode.isEmpty()) {
            ...
            if (Cashier != null) {
                ...
                if (!checkDRCode(DrCode)) {
                    JOptionPane.showMessageDialog(null, "DR Number Doesn't Exist", "Error", JOptionPane.ERROR_MESSAGE);
                    drCode.setText("");
                } else {
                    // Attempt to update the existing DR number
                    String updateQuery = "UPDATE drgenerator SET CustomerID = ?, CashierID = ?, DeliveryDate = ?, DRStatus = ? WHERE DRNo = ?";
                    try (Connection conn = db.getConnection();
                        ...
                        pst.setString(5, DrCode);

                        int rowsAffected = pst.executeUpdate();
                        if (rowsAffected > 0) {
                            JOptionPane.showMessageDialog(null, "Delivery Receipt Updated!");
                            DRTransactions drt = new DRTransactions();
                            JDesktopPane desktopPane = (JDesktopPane) getParent();
                            desktopPane.add(drt);
                            drt.setVisible(true);
                            ...
                            JOptionPane.showMessageDialog(null, "Failed to update Delivery Receipt", "Error", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (SQLException ex) {
