...
public static boolean checkCode(String codes) {
    ...
    private void initComponents() {
        ...
        PManufacturingDate = new com.toedter.calendar.JDateChooser();
        jLabel9 = new javax.swing.JLabel();
        PExpiryDate = new com.toedter.calendar.JDateChooser();
        ...
        jPanel2.add(PFlavor);
        PFlavor.setBounds(400, 100, 280, 30);
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 0, 0, 0, new java.awt.Color(0, 102, 51)));
        ...
        jPanel3.add(jLabel5);
        jLabel5.setBounds(120, 20, 170, 22);

        PManufacturingDate.setForeground(new java.awt.Color(0, 102, 51));
        PManufacturingDate.setDateFormatString("yyyy-MM-dd");
        jPanel3.add(PManufacturingDate);
        PManufacturingDate.setBounds(300, 20, 240, 30);

        jLabel9.setFont(new java.awt.Font("Microsoft YaHei", 0, 16)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 102, 51));
        jLabel9.setText("Expiry Date: ");
        jPanel3.add(jLabel9);
        jLabel9.setBounds(120, 70, 150, 22);

        PExpiryDate.setForeground(new java.awt.Color(0, 102, 51));
        PExpiryDate.setToolTipText("");
        PExpiryDate.setDateFormatString("yyyy-MM-dd");
        jPanel3.add(PExpiryDate);
        PExpiryDate.setBounds(300, 70, 240, 30);

        jPanel2.add(jPanel3);
        jPanel3.setBounds(20, 340, 700, 120);
        ...
        jLabel2.setText("Durability");
        jLabel2.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        jPanel2.add(jLabel2);
        jLabel2.setBounds(10, 310, 720, 30);
        ...
        jLabel14.setBounds(290, 150, 110, 20);

        PQuantity.setBackground(new java.awt.Color(240, 240, 240));
        PQuantity.setFont(new java.awt.Font("Tahoma", 0, 17)); // NOI18N
        PQuantity.setForeground(new java.awt.Color(0, 102, 51));
        PQuantity.setText(" ");
        PQuantity.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 102, 0)));
        PQuantity.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PQuantityActionPerformed(evt);
            }
        });
        jPanel2.add(PQuantity);
        PQuantity.setBounds(400, 140, 280, 30);
        ...
        jLabel12.setBounds(290, 68, 110, 22);
        ...
        jLabel15.setBounds(270, 10, 440, 40);
    ...
    private void saveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveMouseClicked
        ...
        Date checkDate = PManufacturingDate.getDate();
        Date checkDate2 = PExpiryDate.getDate();
        ...
        LocalDate manufacturingDate = LocalDate.parse(manufacturing);
        ...
        // Validate dates
        if (manufacturingDate.isBefore(currentDate) && expiryDate.isAfter(currentDate)) {
            status = "GOOD PRODUCT";
        } else {
            status = "EXPIRED";
        }
        ...
        if(photo.getIcon() == null
            ...
            PUnit.setText("");
        }else if (!isNumber(PQuantity.getText()) && PQuantity.getText().equals(0)){
            PQuantity.setText(" ");
        ...
        try{
            if(db.insertData("INSERT INTO product_information (P_Code, P_Photo, P_Name, P_Flavor, P_Quantity, "
                    + "P_Price, P_Net, P_Unit, P_Manufacturing,P_Expiry, P_Status) "
                    + "VALUES ('"+code.getText()+"',"
                    + " '"+destination+"',"
                    + " '"+PName.getText()+"', "
                    + " '"+PFlavor.getText()+"', "
    ...
    private com.toedter.calendar.JDateChooser PExpiryDate;
    private javax.swing.JTextField PFlavor;
    private com.toedter.calendar.JDateChooser PManufacturingDate;
