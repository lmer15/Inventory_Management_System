 ...
 * @author Elmer Rapon
 */
public class ExpiredProducts extends javax.swing.JInternalFrame {
    ...
    public void displayData() {
        ...
        try {
            ...
            String sql = "SELECT SUM(DamageQuantity) AS count FROM damageproduct WHERE Status = 'EXPIRED'";
    ...
    private void initComponents() {
        ...
        textSearch3.setBounds(390, 150, 300, 30);
        ...
        buttonSearch.setBounds(700, 150, 40, 30);
        ...
        jLabel1.setText("<html>TOTAL NUMBER OF EXPIRED PRODUCTS</html>");
        jPanel2.add(jLabel1);
